    ...
    >
      <div className="flex justify-between items-center mb-2 bai-jamjuree-regular">
        <h2 className="md:text-xl text-lg font-bold flex items-center gap-2">
          Docs <FiFile className="text-indigo-500" />
        </h2>
          ...
          user?.Contributions_user_id_fkey.map((conv, index) => (
            <motion.div
              ...
              className="flex-none w-[280px] md:w-[320px] snap-center p-4 rounded-xl 
                     ...
                     transition-all cursor-pointer shadow-xl hover:shadow-indigo-500/10"
            >
              ...
              <div className="flex justify-end items-center">
                <Link
                  onClick={() =>
                    !user?.IsPremiumUser &&
                    toast.info("Become a premium member to view history.")
                  }
                  to={
                    user?.IsPremiumUser
                  ...
                  className="text-[11px] font-bold text-indigo-500 hover:text-indigo-400 uppercase tracking-wider"
                >
                  View Full Chat →
                </Link>
              </div>
