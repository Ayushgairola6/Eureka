    ...
    <div className="w-full mb-4">
      ...
      >
        ...
        >
          ...
          {/* Chevron Icon */}
          <button
            className={`p-1 rounded-full transition-transform duration-200 text-gray-400 group-hover:text-gray-600 dark:group-hover:text-gray-200 ${
              isOpen ? "rotate-180 bg-gray-100 dark:bg-zinc-800" : ""
            }`}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              ...
              <div className="mt-3">
                ...
                <div className="flex flex-wrap gap-2">
                  {sourceIcons.map((icon, idx) => (
                    <div
                      key={idx}
                      className="flex items-center gap-2 bg-gray-50 dark:bg-zinc-800/50 border border-gray-200 dark:border-zinc-700 rounded-md px-2 py-1.5 hover:bg-gray-100 dark:hover:bg-zinc-800 transition-colors"
                    >
                      ...
                      <span className="text-xs text-gray-700 dark:text-gray-300 truncate max-w-[150px]">
                        Source {idx + 1}{" "}
                        {/* Use domain name if available in your data */}
                      </span>
                    </div>
                  ))}
                </div>
