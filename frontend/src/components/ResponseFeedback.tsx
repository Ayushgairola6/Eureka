  ...
  return (
    <>
      <div className="p-2 rounded-lg bg-gray-100 dark:bg-black border border-gray-200 dark:border-gray-700 mt-4">
        {/* Rating prompt */}
        <h1 className="bai-jamjuree-regular text-sm text-black dark:text-white my-2">
          How would you rate this information?
        </h1>

        {/* Contributors display - simplified */}
        {docUsed.length > 0 && chat.sent_by !== "You" && (
            ...
            <div className="flex flex-wrap gap-1">
              {docUsed
                .filter(
                  (doc, index, self) =>
                    index ===
                    self.findIndex((d) => d.uploaded_by === doc.uploaded_by)
                )
                .map((doc, index) => (
                  <span
                    key={index}
                    className="bg-white dark:bg-gray-700 px-2 py-1 rounded-md text-xs text-gray-700 dark:text-gray-200 border border-gray-200 dark:border-gray-600"
                  >
                    {doc?.uploaded_by}
                  </span>
                ))}
            ...
            <button
              ...
              className={`p-2 rounded-full transition-colors ${
                likeness === "upvote"
                  ...
                  : "bg-white dark:bg-gray-800 text-gray-500 dark:text-gray-400 border border-gray-200 dark:border-gray-600 hover:bg-green-50 dark:hover:bg-green-900/20"
              }`}
              title="Helpful"
            >
              <FaThumbsUp size={14} />
            ...
            <button
              ...
              className={`p-2 rounded-full transition-colors ${
                likeness === "downvote"
                  ...
                  : "bg-white dark:bg-gray-800 text-gray-500 dark:text-gray-400 border border-gray-200 dark:border-gray-600 hover:bg-red-50 dark:hover:bg-red-900/20"
              }`}
              title="Incorrect"
            >
            ...
            <button
              ...
              className={`p-2 rounded-full transition-colors ${
                likeness === "partial_upvote"
                  ...
                  : "bg-white dark:bg-gray-800 text-gray-500 dark:text-gray-400 border border-gray-200 dark:border-gray-600 hover:bg-blue-50 dark:hover:bg-blue-900/20"
              }`}
