  ...
  const PlanDetails = [
    {
      ...
      features: [
        ...
        "Short term memory for AI", // Sells the "Long Memory" upgrade
    ...
    },
    {
      ...
      not_available: ["Custom Enterprise RAG", "Dedicated Room Infrastructure", 'Dedicated support'],
      validity: "Per Month",
      cta: "Order now",
    ...
    },
    {
      ...
      features: [
        ...
        "Better model reasoning capabilities",
