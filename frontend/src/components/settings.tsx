        ...
        {isLoggedIn === false && (!user?.email || user.email === "") && (
          <div className="flex items-center gap-6">
            ...
            <Link to="/Register">
              ...
              >
                {/* Button Content */}
                <div className="relative z-10 px-5 py-1.5 bg-transparent group-hover:bg-emerald-500/5 dark:group-hover:bg-emerald-400/10 transition-colors duration-300 cursor-pointer flex items-center justify-center gap-2">
