      ...
      <section className="relative overflow-hidden bg-white dark:bg-black w-full py-20 border-t border-gray-100 dark:border-white/5">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center gap-6 px-4">
          ...
          <div className="flex flex-col sm:flex-row gap-4 items-center">
            <button className="bg-black dark:bg-white text-white dark:text-black shadow-[0_20px_50px_rgba(8,_112,_184,_0.1)] hover:shadow-cyan-500/20 transition-all rounded-xl py-3 px-6 bai-jamjuree-semibold text-lg active:scale-95">
