...
const UserChatRooms = () => {
  ...
  return (
    <>
      <div className="dark:bg-black bg-white h-screen  flex p-2 flex items-center justify-between gap-3 relative overflow-hidden">
        <section className="border  w-full h-full">
          <span className="space-grotesk flex items-center justify-between px-2 py-2 ">
            ...
            <button
              ...
              className=" z-[3]  rounded-sm py-1 px-2  text-xs space-grotesk flex items-center justify-center dark:bg-white/10 lg:hidden bg-black/10 dark:text-white text-black md:hidden flex items-center justify-center gap-2 hover:shadow-blue-600/30 shadow-xl transition-all duration-300"
            >
