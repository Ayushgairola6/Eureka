...
const Privacy = () => {
    return (
        <div className="bg-white/95 dark:bg-black backdrop-blur-sm rounded-2xl shadow-xl border border-gray-400 px-4 py-6 sm:px-6 sm:py-8 w-full flex flex-col items-center gap-6 md:gap-8 hover:shadow-2xl transition-all duration-300">
            {/* Header Section */}
            <div className="text-center space-y-3 w-full">
                ...
                <p className="text-sm sm:text-base md:text-lg space-grotesk text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
                    Your <span className="font-semibold text-indigo-600 dark:text-indigo-400">confidential</span> knowledge base,
                    powered by <span className="font-semibold text-purple-600 dark:text-purple-400">secure RAG</span>
                </p>
                    ...
                    <div className="flex items-start gap-3 sm:gap-4">
                        ...
                        <div>
                            ...
                            <p className="mt-1 sm:mt-2 text-sm text-gray-600 dark:text-gray-300 bai-jamjuree-regular">
                                Just click <span className="font-mono bg-indigo-100/70 dark:bg-indigo-900/30 text-indigo-800 dark:text-indigo-200 px-1.5 sm:px-2 py-0.5 sm:py-1 rounded-md">My Docs</span>
                    ...
                    <div className="flex items-start gap-3 sm:gap-4">
                        ...
                        <div>
                            ...
                            <p className="mt-1 sm:mt-2 text-sm text-gray-600 dark:text-gray-300 bai-jamjuree-regular">
                                ...
                                <Link to="/API/featured" className="mx-1 font-mono bg-purple-100/70 dark:bg-purple-900/30 text-purple-800 dark:text-purple-200 px-1.5 sm:px-2 py-0.5 sm:py-1 rounded-md hover:underline">
                                    API key
                                </Link>
            ...
            <div className="w-full mt-4 p-4 sm:p-5 bg-gradient-to-r from-gray-50 to-blue-50 dark:from-gray-800/50 dark:to-blue-900/20 rounded-xl border border-gray-200 dark:border-gray-700 bai-jamjuree-regular">
                <div className="flex flex-col md:flex-row items-center justify-between gap-3 sm:gap-4">
                    <div className="text-center">
                        ...
                        <p className="font-medium text-xs sm:text-sm">Upload Private<br />Documents</p>
                    </div>
                    ...
                    <div className="text-center">
                        ...
                        <p className="font-medium text-xs sm:text-sm">Get API Key<br />(One-Time)</p>
                    </div>
                    <RiArrowRightSLine className="w-6 h-6 sm:w-8 sm:h-8 text-gray-400 dark:text-gray-500 hidden md:block" />
                    <RiArrowDownSLine className="w-6 h-6 sm:w-8 sm:h-8 text-gray-400 dark:text-gray-500 md:hidden" />
                    <div className="text-center">
                        ...
                        <p className="font-medium text-xs sm:text-sm">Query Through<br />API/Interface</p>
                    </div>
                </div>
            </div>

            {/* Security Assurance */}
            <div className="w-full mt-4 sm:mt-6 p-4 sm:p-5 bg-gradient-to-r from-gray-50 to-indigo-50 dark:from-gray-800/50 dark:to-indigo-900/20 rounded-xl border border-gray-200 dark:border-gray-700">
                <h3 className="text-base sm:text-lg font-semibold text-gray-800 dark:text-gray-100 flex items-center gap-2">
                    <RiShieldCheckFill className="w-4 h-4 sm:w-5 sm:h-5 text-indigo-600 dark:text-indigo-400" />
                ...
                <ul className="mt-2 sm:mt-3 space-y-1.5 sm:space-y-2 pl-1 sm:pl-2">
                    <li className="flex items-start gap-2">
                        ...
                        <span className="text-sm text-gray-600 dark:text-gray-300">Documents <span className="font-semibold">never</span> used for training other models</span>
                    </li>
                    <li className="flex items-start gap-2">
                        <RiCheckDoubleFill className="w-4 h-4 sm:w-5 sm:h-5 text-green-500 mt-0.5 flex-shrink-0" />
                        <span className="text-sm text-gray-600 dark:text-gray-300">Enterprise-grade <span className="font-semibold">encryption</span> at rest and in transit</span>
                    </li>
                    <li className="flex items-start gap-2">
                        <RiCheckDoubleFill className="w-4 h-4 sm:w-5 sm:h-5 text-green-500 mt-0.5 flex-shrink-0" />
                        <span className="text-sm text-gray-600 dark:text-gray-300">Optional <span className="font-semibold">self-hosting</span> for maximum control</span>
                    </li>
                </ul>
            </div>
            ...
            <div className="flex justify-end items-center flex-wrap w-full mt-2 sm:mt-4">
                <Link
                    className="flex items-center space-grotesk text-indigo-400  gap-1 sm:gap-2 text-xs sm:text-sm hover:underline"
                    to="/docs/page4"
                >
                    Next <FaArrowRight className="w-3 h-3 sm:w-4 sm:h-4" /> <span>API functions</span>
                </Link>
            </div>
        </div>
    );
