...
const Why = () => {
    ...
    return (<>
        <motion.div  className="relative min-h-screen py-16 px-4 sm:px-6 z-[1] overflow-hidden">
            {/* Enhanced gradient background */}
            <div className="z-[-2] absolute inset-0 bg-gradient-to-br from-sky-600/20 to-red-400/20 blur-3xl"></div>
            ...
            <div className="max-w-4xl mx-auto text-center  mb-8">
               ...
               <div></div>
                ...
                <p className="text-center text-gray-700 text-xs md:text-sm space-grotesk ">Reason for existence of such a tool , even though there are multiple ai knowledge based tools already in the market!</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mx-auto cursor-pointer transition-all duration-500 px-2 ">
                ...
                <motion.div initial={{ opacity: 0 }} 
                    whileInView={{ opacity: 1 }} whileHover={{ boxShadow: "2px 2px 2px black"}} transition={{ duration: 0.5 }} className="group relative py-8 px-4 bg-white/90 backdrop-blur-sm rounded-xl border border-gray-300  ">
                    ...
                    <div className=" flex items-start gap-4">
                        <div className="p-2 rounded-lg bg-blue-100/80 group-hover:bg-blue-100 transition-colors duration-300">
                            <FiZap className="w-5 h-5   group-hover:rotate-360 transition-all duration-500" />
                        </div>
                        ...
                        <div>
                            ...
                            <p className="space-grotesk text-gray-500">
                ...
                {/* Card 2: Open Source */}
                <motion.div initial={{ opacity: 0 }} 
                    whileInView={{ opacity: 1 }} whileHover={{ boxShadow: "2px 2px 2px black"}} transition={{ duration: 0.5 }} className="group relative py-8 px-2 bg-white/90 backdrop-blur-sm rounded-xl border border-gray-300 ">
