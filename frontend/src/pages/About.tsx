...
const About = () => {
    return (
        <div className="relative flex flex-col items-center justify-center min-h-screen w-full overflow-hidden bg-gray-50 dark:bg-black z-[1] p-4 sm:p-8">
            ...
            <div className='h-full w-full absolute top-0 left-0 z-[-1] bg-gradient-to-br from-red-400/20 to-emerald-600/20 dark:from-black dark:to-black blur-3xl'>
            </div>
            ...
            <div className="max-w-4xl w-full bg-white/80 dark:bg-black backdrop-blur-sm rounded-2xl shadow-xl border border-gray-300 dark:border-gray-600 p-6 md:p-12 z-[1] my-10">
                ...
                <h1 className="space-grotesk text-2xl md:text-3xl font-bold text-center text-gray-800 dark:text-white mb-6">
                    Quick Start Guide to <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-sky-600 dark:from-purple-400 dark:to-sky-400">EUREKA</span>
                </h1>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                    ...
                    >
                        ...
                        <h3 className="space-grotesk text-xl font-semibold text-gray-800 dark:text-white mb-2">1. Upload Your Knowledge</h3>
                    ...
                    >
                        ...
                        <h3 className="space-grotesk text-xl font-semibold text-gray-800 dark:text-white mb-2">2. Ask Anything, Instantly</h3>
                        <p className="bai-jamjuree-light text-gray-600 dark:text-gray-300">
                    ...
                    >
                        ...
                        <h3 className="space-grotesk text-xl font-semibold text-gray-800 dark:text-white mb-2">3. Leverage Shared Insights</h3>
                        <p className="bai-jamjuree-light text-gray-600 dark:text-gray-300">
                    ...
                    >
                        ...
                        <h3 className="space-grotesk text-xl font-semibold text-gray-800 dark:text-white mb-2">4. Receive & Share Accurate Data</h3>
                        <p className="bai-jamjuree-light text-gray-600 dark:text-gray-300">
                ...
                <div className="mt-16 text-center text-gray-700 dark:text-gray-300">
                    ...
                    <p className="bai-jamjuree-light text-md mb-4">
                        Explore our comprehensive <Link to="/" className='text-purple-600 dark:text-purple-400 hover:underline'>User Manual</Link>, browse <Link to="/" className='text-purple-600 dark:text-purple-400 hover:underline'>FAQs</Link>, or join our <Link to="/" className='text-purple-600 dark:text-purple-400 hover:underline'>Community Forum</Link> for direct support and discussions.
                    </p>
                </div>
            </div>
        </div>
