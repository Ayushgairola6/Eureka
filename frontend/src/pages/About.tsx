...
const About = () => {
    return (
        <div className="relative flex flex-col items-center justify-center min-h-screen w-full overflow-hidden bg-gray-50 z-[1] p-4 sm:p-8">
            ...
            <div className='h-full w-full absolute top-0 left-0 z-[-1] bg-gradient-to-br from-gray-50 to-emerald-600/10 blur-3xl'>
            </div>

            {/* Main Content Area */}
            <div className="max-w-4xl w-full bg-white bg-opacity-80 rounded-xl shadow-xl p-4 md:p-12 z-[1] my-10 ">

                <h1 className="space-grotesk text-3xl md:text-5xl font-bold text-center text-gray-800 mb-8">
                ...
                <p className="bai-jamjuree-light text-md md:text-lg text-center text-gray-600 mb-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
                    ...
                    <motion.div whileHover={{transform:"translateY(-30px)",boxShadow:"2px 2px 2px black"}} transition={{duration:0.7}} className="flex flex-col items-center text-center   py-8 px-2 bg-white/90 backdrop-blur-sm rounded-xl border border-gray-300">
                    ...
                    <motion.div whileHover={{transform:"translateY(-30px)",boxShadow:"2px 2px 2px black"}} transition={{duration:0.7}} className="flex flex-col items-center text-center  shadow-sm py-8 px-2 bg-white/90 backdrop-blur-sm rounded-xl border border-gray-300">
                        <motion.div // Using motion.div to apply animation to the icon container
                            initial={{ scale: 0.8, opacity: 0 }}
                            animate={{ scale: 1, opacity: 1 }}
                ...
                <div className="mt-16 text-center text-gray-700">
                    ...
                    <p className="bai-jamjuree-light text-md mb-4">
                        Explore our comprehensive <Link to="/docs/advanced" className='text-purple-700 hover:underline'>User Manual</Link>, browse <Link to="/faq" className='text-purple-700 hover:underline'>FAQs</Link>, or join our <Link to="/community" className='text-purple-700 hover:underline'>Community Forum</Link> for direct support and discussions.
                    </p>
                </div>
